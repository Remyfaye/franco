...
function ProductsTab() {
    ...
    const handleEditSubmit = async (event)=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handlePut"])(`admin/products/${editingProduct.id}`, formData);
            if (!response.ok) {
